...
class Ros(BaseRos):
    ...
    #     """/interface/bridge"""
    #     return self._interface.bridge
    #
    # @property
    # def ethernet(self) -> EthernetModule:
    #     """/interface/ethernet"""
    #     return self._interface.ethernet
    ...
    @property
    def userman(self):
        from . import UsermanModule
        """/user-manager"""
        if not self._userman:
            self._userman = UsermanModule(self, "/user-manager")
        return self._userman
